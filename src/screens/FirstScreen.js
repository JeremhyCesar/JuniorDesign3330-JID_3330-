...
export const FirstScreen = ({ navigation }) => {
    ...
    return (
        <View style={{alignItems: 'center', backgroundColor: 'white', height: '100%'}}>
            ...
            <TouchableOpacity onPress={() => navigation.navigate('LoginScreen')} style={{borderRadius: 24, backgroundColor: '#054584', width: '75%', height: 60, top: 35, shadowOffset: {height: 5}, shadowColor: 'black', shadowOpacity: 0.25, elevation: 3}}>
                <Text style={{top: 10, alignSelf: 'center', fontSize: 26, color: '#ffffff'}}>LOGIN</Text>
            </TouchableOpacity>
            <TouchableOpacity onPress={() => navigation.navigate('RegisterScreen')} style={{borderRadius: 24, backgroundColor: '#ffffff', borderColor: '#054584', borderWidth: 4, width: '75%', height: 60, top: 55, shadowOffset: {height: 5}, shadowColor: 'black', shadowOpacity: 0.15, elevation: 3}}>
