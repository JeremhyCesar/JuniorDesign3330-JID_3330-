    ...
    return (
        <View>
            ...
            <View style={{position: 'absolute', left: '10%', top: 200, width: '80%'}}>
                ...
                <Text style={{fontWeight: 'bold', position: 'absolute', fontSize: 12, left: 8, top: 73}}>Full Name</Text>
                <TextInput onChangeText={setName} placeholderTextColor='#888888' placeholder={'Julie Smith'} textContentType='name' inputMode='text' style={{fontSize: 16, position: 'absolute', top: 90, height: 40, width: '100%', padding: 10, borderRadius: 6, borderWidth: 1, borderColor: '#888888'}}/>
                <Text style={{fontWeight: 'bold', position: 'absolute', fontSize: 12, left: 8, top: 133}}>e-mail address</Text>
                <TextInput onChangeText={setEmail} placeholderTextColor='#888888' placeholder={'juliesmith@gmail.com'} textContentType='emailAddress' inputMode='email' style={{fontSize: 16, position: 'absolute', top: 150, height: 40, width: '100%', padding: 10, borderRadius: 6, borderWidth: 1, borderColor: '#888888'}}/>
                <Text style={{fontWeight: 'bold', position: 'absolute', fontSize: 12, left: 8, top: 193}}>password</Text>
                <TextInput onChangeText={setPassword} placeholderTextColor='#888888' placeholder={'••••••••••'} textContentType='password' secureTextEntry={true} style={{fontSize: 16, position: 'absolute', top: 210, height: 40, width: '100%', padding: 10, borderRadius: 6, borderWidth: 1, borderColor: '#888888'}}/>
                <Text style={{fontWeight: 'bold', position: 'absolute', fontSize: 12, left: 8, top: 253}}>confirm password</Text>
                <TextInput onChangeText={setPassConf} placeholderTextColor='#888888' placeholder={'••••••••••'} textContentType='password' secureTextEntry={true} style={{fontSize: 16, position: 'absolute', top: 270, height: 40, width: '100%', padding: 10, borderRadius: 6, borderWidth: 1, borderColor: '#888888'}}/>
